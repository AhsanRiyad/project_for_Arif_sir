...
Vue.component("password_recovery",{template:password_recovery,data:()=>({name:"riyad---vue",dialog:!1,status_text:"",password_input:!0,password:"",password_validity:"",repassword_input:!0,repassword:"",repassword_validity:"",changes:{password:{smallText:{color:"#2196f3"},smallButton:{color:"white",backgroundColor:"#2196f3"}},repassword:{smallText:{color:"#2196f3"},smallButton:{color:"white",backgroundColor:"#2196f3"}}}}),methods:{enable_input:function(s){"password"==s&&(this.password_input=!1,this.changes.password.smallText.color="red",this.changes.password.smallButton.color="white",this.changes.password.smallButton.backgroundColor="red"),"repassword"==s&&(this.repassword_input=!1,this.changes.repassword.smallText.color="red",this.changes.repassword.smallButton.color="white",this.changes.repassword.smallButton.backgroundColor="red")},validityCheckInput(s){if("password"==s){var t=/[\S]{6,}/g.test(this.password);this.password_validity=0==t?"invalid":"valid"}else if("repassword"==s){t=/[\S]{6,}/g.test(this.repassword);this.repassword_validity=0==t?"invalid":"valid"}},submit(){this.validityCheckInput("password"),this.validityCheckInput("repassword"),"valid"==this.password_validity&&this.password==this.repassword?axios.post(this.model.modelProfile_update,{purpose:"password",password:this.password,email:this.email}).then(function(s){this.status_text="Password Updated successfully",this.dialog=!0}.bind(this)).catch(function(s){}.bind(this)):(this.status_text="password doesnt match",this.dialog=!0)}},created(){}}),Vue.component("forgot_password",{template:forgot_password,props:["invalid_link"],data:()=>({loading:!1,status_text:"",email:"",email_validity:"",login_status:""}),methods:{submit:function(){this.invalid_link="",this.loading=!0,"valid"==this.email_validity?axios.post(this.model.modelProfile_update,{purpose:"forgot_password",email:this.email}).then(function(s){this.loading=!1,this.login_status=s.data}.bind(this)).catch(function(s){this.loading=!1}.bind(this)):(this.loading=!1,this.login_status="invalid_email")},onChangeValidity(s){if("email"==s){var t=/^[a-zA-Z]{1}[a-zA-Z1-9._]{3,15}@[a-zA-Z]{1}[a-zA-Z1-9]{3,15}\.[a-zA-Z]{2,10}(\.[a-zA-Z]{2})*$/g.test(this.email);this.email_validity=0==t?"invalid":"valid"}}},created(){},updated(){}});var forgot=new Vue({el:"#app",vuetify:new Vuetify,data:{componet_name:"forgot_password",invalid_link:""},methods:{},beforeCreate(){},created(){"not_set"!=this.email.trim()&&axios.post(this.model.modelProfile_update,{purpose:"forgot_password_recovery",email:this.email.trim(),forgot_password_crypto:this.forgot_password_crypto.trim()}).then(function(s){"allow"==s.data?this.componet_name="password_recovery":(this.invalid_link=s.data,this.componet_name="forgot_password")}.bind(this)).catch(function(s){}.bind(this))},beforeMount(){},mounted(){},beforeUpdated(){},updated(){}});
