...
registratrion_status="",Vue.component("add_user",{template:add_user,data:()=>({name:"riyad---vue",dialog:!1,status_text:"",full_name:"green",email:"",mobile:"",institution_id:"",password:"",full_name_validity:"green",email_validity:"",mobile_validity:"",institution_id_validity:"",password_validity:"",registratrion_status:"default",loading:!1}),methods:{full_name_change:function(){/(^[A-Za-z\s\.]{3,}$)/g.test(this.$refs.full_name.value)?(this.name_result="Name is accepeted",this.full_name_color="green"):(this.name_result="Name is not accepeted",this.full_name_color="red")},changeType:function(){this.registratrion_status="NO"},submit:function(){this.loading=!0,"valid"==this.full_name_validity&&"valid"==this.institution_id_validity&&"valid"==this.mobile_validity&&"valid"==this.email_validity&&"valid"==this.password_validity?axios.post(this.model.modelRegirstration,{full_name:this.$refs.full_name.value,institution_id:this.institution_id,email:this.email,mobile:this.mobile,password:this.password}).then(function(i){this.registratrion_status=i.data,this.loading=!1}.bind(this)).catch(function(i){this.loading=!1}):(this.loading=!1,this.status_text="invalid field detected",this.dialog=!0)},onChangeValidity(i){if("full_name"==i){var t=/[A-Za-z.\s]{5,}/g.test(this.$refs.full_name.value);this.full_name_validity=0==t?"invalid":"valid"}else if("institution_id"==i){t=/[A-Za-z\S]{5,}/g.test(this.institution_id);this.institution_id_validity=0==t?"invalid":"valid"}else if("mobile"==i){t=/[\+]{0,1}[\d]{11,}/g.test(this.mobile);this.mobile_validity=0==t?"invalid":"valid"}else if("email"==i){t=/^[a-zA-Z]{1}[a-zA-Z1-9._]{3,15}@[a-zA-Z]{1}[a-zA-Z1-9]{3,15}\.[a-zA-Z]{2,10}(\.[a-zA-Z]{2})*$/g.test(this.email);this.email_validity=0==t?"invalid":"valid"}else if("password"==i){t=/[\S]{6,}/g.test(this.password);this.password_validity=0==t?"invalid":"valid"}}},beforeCreate(){},created(){},beforeMount(){},mounted(){},beforeUpdated(){},updated(){}});var registration_page=new Vue({el:"#app",vuetify:new Vuetify,data:{name:"riyad---vue",name_result:"",full_name_color:"green"},methods:{full_name_change:function(){/(^[A-Za-z\s\.]{3,}$)/g.test(this.$refs.full_name.value)?(this.name_result="Name is accepeted",this.full_name_color="green"):(this.name_result="Name is not accepeted",this.full_name_color="red")}},beforeCreate(){},created(){},beforeMount(){},mounted(){},beforeUpdated(){},updated(){}});
