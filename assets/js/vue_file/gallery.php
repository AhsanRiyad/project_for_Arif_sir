...
Vue.component("gallery",{template:gallery,data:()=>({dialogm1:"",dialog:!1,dialog_photo:"",dialog_photo_baseName:"",recent_photo:"",old_photo:"",group_photo:[],recent_photos:"assets/img/uploads/recent_photos/",old_photos:"assets/img/uploads/old_photos/",group_photos:"assets/img/uploads/group_photos/",uploads:"assets/img/uploads/",loading:!1,photo_delete_status:"",button_disabled:!1}),methods:{zoom_in(o,t){this.button_disabled=!1,this.photo_delete_status="",this.dialog_photo_baseName=t,this.dialog_photo=o,this.dialog=!0},deletePhoto(){this.loading=!0,axios.post(this.model.modelGallery,{purpose:"deletePhoto",basename:this.dialog_photo_baseName}).then(function(o){this.loading=!1,this.recent_photo=o.data.recent_photo,this.old_photo=o.data.old_photo,this.group_photo=o.data.group_photo,this.photo_delete_status="Your photo has been deleted",this.button_disabled=!0}.bind(this)).catch(function(o){this.loading=!1}.bind(this))}},created(){axios.post(this.model.modelGallery,{purpose:"getPhotos"}).then(function(o){this.recent_photo=o.data.recent_photo,this.old_photo=o.data.old_photo,this.group_photo=o.data.group_photo}.bind(this)).catch(function(o){}.bind(this))}});var gallery=new Vue({el:"#app",vuetify:new Vuetify});
